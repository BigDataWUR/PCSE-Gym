...
class TestModel(unittest.TestCase):
    def test_model(self):
        ...
        self.assertAlmostEqual(summary.loc[[(1992, (48, 0))]]['WSO'].values[0], 263.7, 0)
        self.assertAlmostEqual(summary.loc[[(1992, (48, 0))]]['reward'].values[0], 25.6, 0)
        self.assertAlmostEqual(summary.loc[[(2002, (52, 5.5))]]['WSO'].values[0], 705.6, 0)
        self.assertAlmostEqual(summary.loc[[(2002, (52, 5.5))]]['reward'].values[0], 252.6, 0)